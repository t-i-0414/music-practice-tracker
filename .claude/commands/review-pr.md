---
description: Comprehensive PR review using specialized sub-agents
---
...
6. **Aggregate Results**
   ...
   After sub-agents complete, summarize:
...
# Launches all sub-agents in parallel
```
...
- **Focus on changes**: Sub-agents analyze git diff by default
