...
description: >-
  Audit and improve agent instruction files (e.g., CLAUDE.md, .cursorrules) in
  repositories. Use when asked to check, audit, update, improve, or fix
  instruction files. Scans for all instruction files, evaluates quality against
  templates, outputs quality report, then makes targeted updates. Also use when
  the user mentions "instruction file maintenance" or "project memory
  optimization".
---
