...
describe('UserAppFacadeService', () => {
  ...
  const mockCreatedUserResponse: ActiveUserResponseDto = {
  ...
  const mockUpdatedUserResponse: ActiveUserResponseDto = {
    ...mockActiveUserResponse,
    name: 'Updated User',
  ...
  describe('createUser', () => {
    ...
    it('should delegate to UserCommandService.createUser', async () => {
      commandService.createUser.mockResolvedValue(mockCreatedUserResponse);
    ...
    it('should propagate errors from command service', async () => {
      ...
      await expect(service.createUser(mockInput)).rejects.toThrow(error);
      expect(commandService.createUser).toHaveBeenCalledWith(mockInput);
    });
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(service.createUser(mockInput)).rejects.toThrow(validationError);
    });
  });
  ...
  describe('updateUserById', () => {
    ...
    it('should delegate to UserCommandService.updateUserById', async () => {
      commandService.updateUserById.mockResolvedValue(mockUpdatedUserResponse);
      ...
      expect(result).toBe(mockUpdatedUserResponse);
    });
    ...
    it('should handle partial updates', async () => {
      ...
      commandService.updateUserById.mockResolvedValue({
        ...mockActiveUserResponse,
        email: 'newemail@example.com',
      });
  ...
  describe('Method delegation patterns', () => {
    ...
    it('should handle concurrent requests independently', async () => {
      ...
      expect(findResult).toBe(mockActiveUserResponse);
      expect(createResult).toBe(mockCreatedUserResponse);
      expect(updateResult).toBe(mockUpdatedUserResponse);
    });
  });
